...
namespace Brafton.DotNetNuke
{
    ...
    //    }
        ...
        public int addCategories(string catUrlHolder)
        {
            using (DNNDataLayerDataContext dnnContext = new DNNDataLayerDataContext())
            {
                ...
                else
                {
                    ...
                    Blog_Category newbc = new Blog_Category();

                    newbc.Category = category;
                    newbc.ParentID = 0;
                    newbc.Slug = tempCatSlug;

                    dnnContext.Blog_Categories.InsertOnSubmit(newbc);
                    dnnContext.SubmitChanges();
                    //set the catID

                    tempCatID = newbc.CatID;
        ...
        public void addBlogCategories(int tempCatID, int entryId)
        {
            using (DNNDataLayerDataContext dnnContext = new DNNDataLayerDataContext())
            {
                //check to see if the cat id and entryid exist together in the Blog_Entry_Categories table
                Blog_Entry_Category bec = dnnContext.Blog_Entry_Categories.FirstOrDefault(x => x.CatID == tempCatID && x.EntryID == entryId);
                ...
                else
                {
                    ...
                    Blog_Entry_Category newbece = new Blog_Entry_Category();

                    newbece.EntryID = entryId;
                    newbece.CatID = tempCatID;

                    dnnContext.Blog_Entry_Categories.InsertOnSubmit(newbece);
                    dnnContext.SubmitChanges();
                            ...
                            //{
                               ...
                               //string displayDate = today.ToString("dd/MM/yyyy");
                                ...
                                #region IMAGE HANDLER 
                                    ...
                                    //TODO need to do some ctageory stuff here
                                    //TODO best to move to its own method (possibly within category.cs) after we get it working
                                    
