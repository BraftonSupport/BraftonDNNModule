    ...
    <asp:UpdatePanel ID="updateAPIKey" runat="server" UpdateMode="Always" EnableViewState="true">
        ...
        <ContentTemplate>
           <div class="firstSelectorHeader"><h2>I have:</h2></div>
            ...
            <p class="authors">
                <h2>Authors:</h2><br />
            <asp:DropDownList runat="server" ID="blogUsersDrpDwn" ClientIDMode="Static" AutoPostBack="true"
                        ViewStateMode="Enabled" /><br />
                <asp:Button ID="setAuthorID" AutoPostBack="true" ClientIDMode="Static" ViewStateMode="Enabled" runat="server"  Text="Choose Article Author" OnClick="setAuthorID_Click" />
                </p>
            ...
            <div id="checks">
                ...
                <p>
                    ...
                    <asp:Label ID="boolAuthorSet" runat="server" /></p>
                <p>
          ...
          <asp:Button ID="ShowGlobals" AutoPostBack="true" ClientIDMode="Static" ViewStateMode="Enabled"
                Visible="true"  runat="server" Text="Show Messages" OnClick="show_globals" />
